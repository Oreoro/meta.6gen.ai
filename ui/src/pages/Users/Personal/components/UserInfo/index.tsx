...
import { userCenterStore, loggedUserInfoStore } from '@/stores';
  ...
  return (
    <div className="d-flex flex-column flex-md-row mb-4">
      ...
      <div className="ms-0 ms-md-4 mt-4 mt-md-0">
        ...
        {/* Hire Me Button - only show if user has freelancer profile and it's not the current user */}
        {hasFreelancerProfile && sessionUser?.id !== data.id && (
          <div className="mb-3">
            <HireMeButton
              freelancerUserId={data.id}
              freelancerUsername={data.username}
              freelancerDisplayName={data.display_name}
              className="me-2"
            />
          </div>
        )}
